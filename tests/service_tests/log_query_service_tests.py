...
class TestLogQueryService:
    def setup_method(self, _method):
        ...
        patcher = patch("app.services.log_query_service.api_help_util.ping", return_value=True)
                ...
                "result": [
                    {
                        "stream": {"job": "test"},
                        "values": [
                            ["1234567890", "2025-06-25T10:15:34.890Z INFO User session created"],
                            ["1234567891", "2025-06-25T10:15:28.890Z INFO Fetching user profile"],
                        ],
                    }
                ]
            }
